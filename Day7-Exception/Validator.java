...
public class Validator {
    public static void main(String[] args) throws InvalidUsername, InvalidPassword{
        ...
        if(!(Character.isUpperCase(first))){
            throw new InvalidUsername("Username should starts with uppercase alphabet letter from A-Z");
        }
        ...
        if((password.contains("(") || password.contains(")") || password.contains(" "))){
            throw new InvalidPassword("Password should not be contain any paranthesis or Whitespace");
        }
