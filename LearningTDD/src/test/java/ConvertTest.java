...
class ConvertTest {
    ...
    class TestAdditionOfMagnitude{
        ...
        public void checkAdditionOfZeroMeterAndHundredCentimeterGivesException(){
            ...
            assertThrows(IllegalArgumentException.class, () -> new Convert(0,100));
        }

        @Test
        public void checkAdditionOfMeterAndHundredCentimeterGivesException(){

            assertThrows(IllegalArgumentException.class, () -> new Convert(200,-1));
        }
    ...
    class TestSubtractionOfMagnitude{
        ...
        public void checkAdditionOfZeroMeterAndHundredCentimeterGivesException(){
            ...
            assertThrows(IllegalArgumentException.class, () -> new Convert(0,50));
        }

        @Test
        public void checkAdditionOfMeterAndHundredCentimeterGivesException(){

            assertThrows(IllegalArgumentException.class, () -> new Convert(2000,-1));
        }
